...
import { toggleMealSelection, updateNumberOfPeople } from "./mealsSlice";
const ConferenceEvent = () => {
  ...
  const handleMealSelection = (index) => {
    ...
    if (item.selected && item.type === "mealForPeople") {
      ...
      dispatch(toggleMealSelection({ index, newNumberOfPeople: 1 }));
    }
  };
  ...
  const calculateTotalCost = (section) => {
    ...
    if (section === "venue") {
      ...
      mealsItems.forEach((item) => {
        if (item.selected) {
          totalCost += item.cost * item.numberOfPeople;
        }
      });
    }
    return totalCost;
              ...
              <div className="input-container venue_selection">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setNumberOfPeople(value); // local state for controlled input
                    dispatch(updateNumberOfPeople({ numberOfPeople: value })); // update redux
                  }}
                />
              </div>
